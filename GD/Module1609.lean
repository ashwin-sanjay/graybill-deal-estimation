...
namespace GD.N0106.N0428.N0770.N1715
...
theorem d027450 {g' g'' : ℝ → ℝ} {c w M : ℝ} (hw : 0 < w)
...
def d027451 (g g' : ℝ → ℝ) (c x : ℝ) : ℝ := g x - g c - g' c * (x - c)



theorem d027452 {g g' g'' : ℝ → ℝ} {c w : ℝ} (hw : 0 < w)
    (hg : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g (g' x) x)
    (hg' : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g' (g'' x) x)
    {x : ℝ} (hx : x ∈ Icc (c - w) (c + w)) :
    _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x = ∫ t in c..x, (g' t - g' c) := by
  have hc : c ∈ Icc (c - w) (c + w) := ⟨by linarith, by linarith⟩
  ...
  unfold _root_.GD.N0106.N0428.N0770.N1715.d027451
  first
  | ring
  | (beta_reduce; ring)
  | (simp only []; ring)
...
theorem d027453 {g g' g'' : ℝ → ℝ} {c w M : ℝ} (hw : 0 < w)
    (hg : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g (g' x) x)
    (hg' : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g' (g'' x) x)
    (hM : ∀ x ∈ Icc (c - w) (c + w), |g'' x| ≤ M)
    {x : ℝ} (hx : x ∈ Icc (c - w) (c + w)) :
    |_root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x| ≤ M / 2 * (x - c) ^ 2 := by
  have hc : c ∈ Icc (c - w) (c + w) := ⟨by linarith, by linarith⟩
  have hsub : uIcc c x ⊆ Icc (c - w) (c + w) := Set.uIcc_subset_Icc hc hx
  have hlip : ∀ t ∈ Icc (c - w) (c + w), |g' t - g' c| ≤ M * |t - c| :=
    fun t ht => _root_.GD.N0106.N0428.N0770.N1715.d027450 hw hg' hM ht
  rw [_root_.GD.N0106.N0428.N0770.N1715.d027452 hw hg hg' hx]
  ...
  · have hxc' : x ≤ c := hxc.le
    ...
    have h2 : (∫ t in x..c, M * (c - t)) = M / 2 * (x - c) ^ 2 := by
      have hd : ∀ t ∈ uIcc x c,
        ...
        exact this.congr_deriv (by
          first
          | (simp only [id_eq, show (2 : ℕ) - 1 = 1 from rfl, pow_one, Nat.cast_ofNat]
             ring)
          | (simp; ring)
          | (norm_num; ring))
      rw [intervalIntegral.integral_eq_sub_of_hasDerivAt hd hGint]
...
theorem d027455 {g g' g'' ρ : ℝ → ℝ} {c w M m₀ m₂ : ℝ}
    (hw : 0 < w)
    (hg : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g (g' x) x)
    (hg' : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g' (g'' x) x)
    (hM : ∀ x ∈ Icc (c - w) (c + w), |g'' x| ≤ M)
  ...
  have hIg : Integrable (fun x => g x * ρ x) := _root_.GD.N0106.N0428.N0770.N1715.d027454 hgc hρc hρz
  have hIρ : Integrable ρ := by
    have h := _root_.GD.N0106.N0428.N0770.N1715.d027454 (g := fun _ => (1 : ℝ)) continuousOn_const hρc hρz
    simpa only [one_mul] using h
  have hI1 : Integrable (fun x => (x - c) * ρ x) :=
    _root_.GD.N0106.N0428.N0770.N1715.d027454 (by fun_prop : Continuous fun x : ℝ => x - c).continuousOn hρc hρz
  have hI2 : Integrable (fun x => (x - c) ^ 2 * ρ x) :=
    _root_.GD.N0106.N0428.N0770.N1715.d027454 (by fun_prop : Continuous fun x : ℝ => (x - c) ^ 2).continuousOn
      hρc hρz
  have hIr : Integrable (fun x => _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x) := by
    have heq : (fun x => _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x) =
        fun x => g x * ρ x - g c * ρ x - g' c * ((x - c) * ρ x) := by
      funext x; unfold _root_.GD.N0106.N0428.N0770.N1715.d027451; ring
    rw [heq]
    exact (hIg.sub (hIρ.const_mul (g c))).sub (hI1.const_mul (g' c))
  have hdecomp : (∫ x, g x * ρ x) = g c * m₀ + ∫ x, _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x := by
    have heq : (fun x => g x * ρ x) =
        fun x => (g c * ρ x + g' c * ((x - c) * ρ x)) + _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x := by
      funext x; unfold _root_.GD.N0106.N0428.N0770.N1715.d027451; ring
    have hsum : Integrable (fun x => g c * ρ x + g' c * ((x - c) * ρ x)) :=
      (hIρ.const_mul (g c)).add (hI1.const_mul (g' c))
    rw [heq, integral_add hsum hIr,
      integral_add (hIρ.const_mul (g c)) (hI1.const_mul (g' c)),
      integral_const_mul, integral_const_mul, hm0, hm1, mul_zero, add_zero]
  have hbound : ∀ x,
      ‖_root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x‖ ≤ M / 2 * ((x - c) ^ 2 * ρ x) := by
    intro x
    rw [Real.norm_eq_abs, abs_mul, abs_of_nonneg (hρ0 x)]
    by_cases hx : x ∈ Icc (c - w) (c + w)
    · calc |_root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x| * ρ x ≤ M / 2 * (x - c) ^ 2 * ρ x :=
            mul_le_mul_of_nonneg_right (_root_.GD.N0106.N0428.N0770.N1715.d027453 hw hg hg' hM hx) (hρ0 x)
  ...
  rw [hdecomp]
  calc |g c * m₀ + (∫ x, _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x) - g c * m₀|
      = |∫ x, _root_.GD.N0106.N0428.N0770.N1715.d027451 g g' c x * ρ x| := by congr 1; ring
    _ ≤ M / 2 * m₂ := hnorm



theorem d027456 {c w x : ℝ} (hw : 0 < w) (hx : x ∉ Icc (c - w) (c + w)) :
...
theorem d027460 (c w : ℝ) (hw : 0 < w) : (∫ x, _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x ^ 2) = 2 * w / 3 := by
  simp_rw [_root_.GD.N0106.N0428.N0770.N1725.d024150 c w _ hw]
...
theorem d027463 {g g' g'' : ℝ → ℝ} {c w M : ℝ} (hw : 0 < w)
    (hg : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g (g' x) x)
    (hg' : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g' (g'' x) x)
    (hM : ∀ x ∈ Icc (c - w) (c + w), |g'' x| ≤ M) :
    |(∫ x, g x * _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x) - g c * w| ≤ M * w ^ 3 / 12 := by
  have h := _root_.GD.N0106.N0428.N0770.N1715.d027455 hw hg hg' hM (_root_.GD.N0106.N0428.N0770.N1725.d024139 c w) (_root_.GD.N0106.N0428.N0770.N1725.d024133 c w)
    (fun x hx => _root_.GD.N0106.N0428.N0770.N1715.d027456 hw hx) (_root_.GD.N0106.N0428.N0770.N1715.d027457 c w hw)
    (_root_.GD.N0106.N0428.N0770.N1715.d027458 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027459 c w hw)
  calc |(∫ x, g x * _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x) - g c * w| ≤ M / 2 * (w ^ 3 / 6) := h
    _ = M * w ^ 3 / 12 := by ring


theorem d027464 {g g' g'' : ℝ → ℝ} {c w M : ℝ} (hw : 0 < w)
    (hg : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g (g' x) x)
    (hg' : ∀ x ∈ Icc (c - w) (c + w), HasDerivAt g' (g'' x) x)
    (hM : ∀ x ∈ Icc (c - w) (c + w), |g'' x| ≤ M) :
    |(∫ x, g x * _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x ^ 2) - g c * (2 * w / 3)| ≤ M * w ^ 3 / 30 := by
  have h := _root_.GD.N0106.N0428.N0770.N1715.d027455 (ρ := fun x => _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x ^ 2) hw hg hg' hM
    ...
    (fun x hx => by
      ...
      rw [_root_.GD.N0106.N0428.N0770.N1715.d027456 hw hx]
      simp)
    (_root_.GD.N0106.N0428.N0770.N1715.d027460 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027461 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027462 c w hw)
  calc |(∫ x, g x * _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x ^ 2) - g c * (2 * w / 3)| ≤ M / 2 * (w ^ 3 / 15) := h
    _ = M * w ^ 3 / 30 := by ring



theorem d027465 {ρe ρF : ℝ → ℝ} {c f w : ℝ}
...
theorem d027466 {g : ℝ × ℝ → ℝ} {ρe ρF : ℝ → ℝ} {c f w : ℝ}
  ...
  exact hI.integrable_of_forall_notMem_eq_zero
    (fun p hp => by rw [_root_.GD.N0106.N0428.N0770.N1715.d027465 hρe hρF hp, mul_zero])




theorem d027467 {g : ℝ × ℝ → ℝ} {gE gEE : ℝ → ℝ}
  ...
  have hIG : Integrable (fun p : ℝ × ℝ => g p * (ρe p.1 * ρF p.2)) (volume.prod volume) :=
    _root_.GD.N0106.N0428.N0770.N1715.d027466 hcont hρec hρFc hρez hρFz
  ...
  have hinnerBound : ∀ e ∈ Icc (c - w) (c + w),
    ...
    _root_.GD.N0106.N0428.N0770.N1715.d027455 hw (hF e he) (hF' e he) (hMF e he) hρF0 hρFc hρFz
      hF0 hF1 hF2
  ...
  have hIline : Integrable (fun e => g (e, f) * ρe e) := _root_.GD.N0106.N0428.N0770.N1715.d027454 hgline hρec hρez
  ...
  have houter : |(∫ e, g (e, f) * ρe e) - g (c, f) * me0| ≤ ME / 2 * me2 :=
    _root_.GD.N0106.N0428.N0770.N1715.d027455 hw hE hE' hME hρe0 hρec hρez he0 he1 he2
  ...
  have hIρe : Integrable ρe := by
    have h := _root_.GD.N0106.N0428.N0770.N1715.d027454 (g := fun _ => (1 : ℝ)) continuousOn_const hρec hρez
    simpa only [one_mul] using h
...
theorem d027468 {g : ℝ × ℝ → ℝ} {gE gEE : ℝ → ℝ}
    ...
    |(∫ p, g p * _root_.GD.N0106.N0428.N0770.N1725.d024125 c f w p ∂(volume.prod volume)) - g (c, f) * w ^ 2| ≤
      (ME + MF) * w ^ 4 / 12 := by
  have h := _root_.GD.N0106.N0428.N0770.N1715.d027467 hw hcont hF hF' hMF hE hE' hME
    (_root_.GD.N0106.N0428.N0770.N1725.d024139 c w) (_root_.GD.N0106.N0428.N0770.N1725.d024133 c w) (fun x hx => _root_.GD.N0106.N0428.N0770.N1715.d027456 hw hx)
    (_root_.GD.N0106.N0428.N0770.N1725.d024139 f w) (_root_.GD.N0106.N0428.N0770.N1725.d024133 f w) (fun y hy => _root_.GD.N0106.N0428.N0770.N1715.d027456 hw hy)
    (_root_.GD.N0106.N0428.N0770.N1715.d027457 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027458 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027459 c w hw)
    (_root_.GD.N0106.N0428.N0770.N1715.d027457 f w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027458 f w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027459 f w hw)
...
theorem d027469 {g : ℝ × ℝ → ℝ} {gE gEE : ℝ → ℝ}
    {gF gFF : ℝ → ℝ → ℝ} {c f w ME MF : ℝ} (hw : 0 < w)
    (hcont : ContinuousOn g (Icc (c - w) (c + w) ×ˢ Icc (f - w) (f + w)))
    (hF : ∀ e ∈ Icc (c - w) (c + w), ∀ F ∈ Icc (f - w) (f + w),
      HasDerivAt (fun F => g (e, F)) (gF e F) F)
    ...
    |(∫ p, g p * _root_.GD.N0106.N0428.N0770.N1725.d024125 c f w p ^ 2 ∂(volume.prod volume)) - g (c, f) * (4 * w ^ 2 / 9)| ≤
      (ME + MF) * w ^ 4 / 45 := by
  have h := _root_.GD.N0106.N0428.N0770.N1715.d027467 (ρe := fun x => _root_.GD.N0106.N0428.N0770.N1725.d024124 c w x ^ 2)
    ...
    (fun y hy => by
      ...
      rw [_root_.GD.N0106.N0428.N0770.N1715.d027456 hw hy]
      simp)
    (_root_.GD.N0106.N0428.N0770.N1715.d027460 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027461 c w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027462 c w hw)
    (_root_.GD.N0106.N0428.N0770.N1715.d027460 f w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027461 f w hw) (_root_.GD.N0106.N0428.N0770.N1715.d027462 f w hw)
...
end GD.N0106.N0428.N0770.N1715

#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027453
#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027455
#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027463
#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027464
#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027467
#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027468
#print axioms _root_.GD.N0106.N0428.N0770.N1715.d027469
