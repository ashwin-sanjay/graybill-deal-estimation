...
namespace GD.N0106.N0428.N0765.N1643
...
private theorem d008459 {s : ℤ → ℂ} {C k : ℝ}
  ...
  have h := _root_.GD.N0106.N0428.N0765.N1643.d008458 hk hk hs hb'
...
theorem d008460
  ...
  have hzero_mode : mode (0, 0) = I := by
    simp only [mode, hφa0, hφb0, hzero, mul_one]
  have haxisB_row : ‖row 0 - I‖ ≤ 2 * Mb / (Real.exp k₀ - 1) := by
    have h := _root_.GD.N0106.N0428.N0765.N1643.d008459 hk₀ (hrow 0) (by
      intro n hn
  ...
  have hrow_bound (m : ℤ) (hm : m ≠ 0) :
    ...
    have htail : ‖row m - mode (m, 0)‖ ≤
      ...
      apply _root_.GD.N0106.N0428.N0765.N1643.d008459 hk₁ (hrow m)
      intro n hn
    ...
    calc
      ...
      _ = _ := by ring
  have houter := _root_.GD.N0106.N0428.N0765.N1643.d008458 hk₀ hk₁ hrows hrow_bound
  have hid : I - T =
      -(((∑' m : ℤ, row m) - row 0) + (row 0 - I)) := by
    rw [hrep]
    change I - (∑' p : ℤ × ℤ, mode p) = _
    rw [hflat]
    ring
  rw [hid, norm_neg]
  calc
    _ ≤ ‖(∑' m : ℤ, row m) - row 0‖ + ‖row 0 - I‖ := norm_add_le _ _
    _ ≤ (2 * Ma / (Real.exp k₀ - 1) +
...
end GD.N0106.N0428.N0765.N1643
