...
abbrev d022000 (k : ℕ) := ℝ × _root_.GD.N0232.N0719.N0983.d009709 k

def d022001 (p : _root_.GD.N0213.N0496.d022000 k) (x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)) : ℝ :=
  _root_.GD.N0232.N0719.N0989.d011346 (d + 2) p.1 (fun i => (_root_.GD.N0232.N0719.N0983.d009710 i p.2 : ℝ)) x

def d022002 (p : _root_.GD.N0213.N0496.d022000 k) (x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)) : ℝ :=
  p.1 * _root_.GD.N0232.N0719.N0989.d011346 (d + 1) p.1 (fun i => (_root_.GD.N0232.N0719.N0983.d009710 i p.2 : ℝ)) x

def d022003 (sizes : Fin k → ℕ) (hdim : (∑ i, sizes i) = d + 1)
    (x : _root_.GD.N0213.N0496.d021972 d) : _root_.GD.N0232.N0719.N0873.d011295 (Fin k) :=
  _root_.GD.N0232.N0719.N0986.d020362 sizes ((_root_.GD.N0232.N0719.N0997.d019807 sizes hdim).symm x)

abbrev d021973 (p : _root_.GD.N0232.N0719.N0983.d009709 k) (i : Fin k) : ℝ := _root_.GD.N0232.N0719.N0983.d009710 i p
...
theorem d021981 (sizes : Fin k → ℕ) (hdim : (∑ i, sizes i) = d + 1) :
    Continuous (_root_.GD.N0213.N0496.d022003 sizes hdim) := by
...
theorem d021982 (lo hi : ℝ) : IsOpen (_root_.GD.N0213.N0496.d021976 (k := k) lo hi) := by
  ...
  · exact isOpen_iInter_of_finite fun i => isOpen_Ioo.preimage
      (show Continuous (fun x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k) => x.1 i) by fun_prop)
  · exact isOpen_iInter_of_finite fun i => isOpen_Ioo.preimage
      (show Continuous (fun x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k) => x.2 i) by fun_prop)
...
theorem d021983 (sizes : Fin k → ℕ)
    ...
    ∃ x : _root_.GD.N0213.N0496.d021972 d, _root_.GD.N0213.N0496.d022003 sizes hdim x ∈ _root_.GD.N0213.N0496.d021976 lo hi ∧ P x := by
  let U := _root_.GD.N0213.N0496.d022003 sizes hdim ⁻¹' _root_.GD.N0213.N0496.d021976 lo hi
...
def d021984 (d : ℕ) (p : I → _root_.GD.N0213.N0496.d022000 k) (weight : I → ℝ)
    (x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)) : ℝ :=
  (∑ i, weight i * _root_.GD.N0213.N0496.d022002 (d := d) (p i) x) /
    (∑ i, weight i * _root_.GD.N0213.N0496.d022001 (d := d) (p i) x)

theorem d021985 (p : I → _root_.GD.N0213.N0496.d022000 k) (weight : I → ℝ)
    (hw : ∀ i, 0 ≤ weight i) (hprob : ∑ i, weight i = 1)
    {lo hi : ℝ} {x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)}
    (hlo : 0 ≤ lo) (hx : x ∈ _root_.GD.N0213.N0496.d021976 lo hi) :
    0 < ∑ i, weight i * _root_.GD.N0213.N0496.d022001 (d := d) (p i) x := by
  have hp (i : I) : 0 < _root_.GD.N0213.N0496.d022001 (d := d) (p i) x := by
...
theorem d021986 (hd : 1 ≤ d)
    (p : I → _root_.GD.N0213.N0496.d022000 k) (weight : I → ℝ)
    (hw : ∀ i, 0 ≤ weight i) (hprob : ∑ i, weight i = 1)
  ...
  have h := _root_.GD.N0232.N0720.N1324.d002956 (d + 1) (by omega) weight
    ...
    (by simpa [_root_.GD.N0213.N0496.d022001, _root_.GD.N0232.N0719.N0989.d011346, Nat.add_assoc, _root_.GD.N0213.N0496.d021973] using
      _root_.GD.N0213.N0496.d021985 (d := d) p weight hw hprob hlo.le hx)
    (by simpa [_root_.GD.N0213.N0496.d021984, _root_.GD.N0213.N0496.d022001, _root_.GD.N0213.N0496.d022002, _root_.GD.N0232.N0719.N0989.d011346, Nat.add_assoc,
...
theorem d021987
    ...
    (p : ∀ j, Index j → _root_.GD.N0213.N0496.d022000 k) (weight : ∀ j, Index j → ℝ)
    ...
    (hlim : ∀ᵐ x ∂(volume : Measure (_root_.GD.N0213.N0496.d021972 d)), Tendsto
      (fun j => _root_.GD.N0213.N0496.d021984 d (p j) (weight j) (_root_.GD.N0213.N0496.d022003 sizes hdim x)) atTop (𝓝 (f x)))
    (hupper : ∀ᵐ x ∂(volume : Measure (_root_.GD.N0213.N0496.d021972 d)),
      ∀ c : ℝ, (∀ i, (_root_.GD.N0213.N0496.d022003 sizes hdim x).1 i ≤ c) → f x ≤ c)
...
def d021988 (p : _root_.GD.N0213.N0496.d022000 k) : _root_.GD.N0213.N0496.d022000 k := (-p.1, p.2)
...
theorem d021992 (p : _root_.GD.N0213.N0496.d022000 k)
    (x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)) :
    _root_.GD.N0213.N0496.d022001 (d := d) (_root_.GD.N0213.N0496.d021988 p) x = _root_.GD.N0213.N0496.d022001 (d := d) p (_root_.GD.N0213.N0496.d021989 x) := by
  simp [_root_.GD.N0213.N0496.d022001, _root_.GD.N0232.N0719.N0989.d011346, _root_.GD.N0213.N0496.d021988, _root_.GD.N0213.N0496.d021990, _root_.GD.N0213.N0496.d021991]

theorem d021993 (p : _root_.GD.N0213.N0496.d022000 k)
    (x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)) :
    _root_.GD.N0213.N0496.d022002 (d := d) (_root_.GD.N0213.N0496.d021988 p) x = -_root_.GD.N0213.N0496.d022002 (d := d) p (_root_.GD.N0213.N0496.d021989 x) := by
  simp [_root_.GD.N0213.N0496.d022002, _root_.GD.N0232.N0719.N0989.d011346, _root_.GD.N0213.N0496.d021988, _root_.GD.N0213.N0496.d021990, _root_.GD.N0213.N0496.d021991]

theorem d021994 (p : I → _root_.GD.N0213.N0496.d022000 k) (weight : I → ℝ)
    (x : _root_.GD.N0232.N0719.N0873.d011295 (Fin k)) :
...
theorem d021995 (sizes : Fin k → ℕ) (hdim : (∑ i, sizes i) = d + 1)
    ...
    _root_.GD.N0213.N0496.d022003 sizes hdim (-x) = _root_.GD.N0213.N0496.d021989 (_root_.GD.N0213.N0496.d022003 sizes hdim x) := by
  have hflat : (_root_.GD.N0232.N0719.N0997.d019807 sizes hdim).symm (-x) = -(_root_.GD.N0232.N0719.N0997.d019807 sizes hdim).symm x := by
    funext i j
    rfl
  unfold _root_.GD.N0213.N0496.d022003
  rw [hflat]
...
theorem d021996
    ...
    (hlower : ∀ᵐ x ∂(volume : Measure (_root_.GD.N0213.N0496.d021972 d)),
      ∀ c : ℝ, (∀ i, c ≤ (_root_.GD.N0213.N0496.d022003 sizes hdim x).1 i) → c ≤ f x)
    {beta : ℝ} (hbeta : 0 ≤ beta) (hhalf : beta < (1 / 2 : ℝ)) :
    ∃ c C cutoff : ℝ, 0 < c ∧ 1 ≤ cutoff ∧ ∀ᶠ j in atTop,
      (∑ i, weight j i * (if cutoff ≤ -(p j i).1 then
        c * Real.exp (beta * (p j i).1 ^ 2) else 0)) ≤ C := by
  ...
  have hlim' : ∀ᵐ x ∂(volume : Measure (_root_.GD.N0213.N0496.d021972 d)), Tendsto
      (fun j => _root_.GD.N0213.N0496.d021984 d (fun i => _root_.GD.N0213.N0496.d021988 (p j i)) (weight j)
        (_root_.GD.N0213.N0496.d022003 sizes hdim x)) atTop (𝓝 (-f (-x))) := by
  ...
  have hupper : ∀ᵐ x ∂(volume : Measure (_root_.GD.N0213.N0496.d021972 d)),
      ∀ c : ℝ, (∀ i, (_root_.GD.N0213.N0496.d022003 sizes hdim x).1 i ≤ c) → -f (-x) ≤ c := by
    filter_upwards [hreflect] with x hx
    intro c hc
